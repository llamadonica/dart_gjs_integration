...
import 'package:gjs_integration/cairo.dart';
import 'package:gjs_integration/gdk.dart' hide Window;
import 'package:gjs_integration/gdk.dart' as gdk show Window;
import 'package:gjs_integration/rsvg.dart';
import 'package:gjs_integration/gtk.dart' hide main, init;
import 'package:gjs_integration/gtk.dart' as gtk show main, init;
...
class ClockFace {
  ...
  ClockFace(int width, this._app) : width = width {
    ...
    window.visual = windowVisual;
    bool shapesOkay = window.display.supportsShapes();
  }
